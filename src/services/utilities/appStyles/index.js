...
export const appStyles = StyleSheet.create({
  ...
  //   right: 0,
  //   bottom: 0,
  //   backgroundColor: '#FFFF', // background color of the tab bar

  //   // Shadow properties to make the shadow appear on top
  //   shadowColor: '#000',
  //   shadowOffset: {
  //     width: 0,
  //     height: -10, // Negative height to make the shadow appear above
  //   },
  //   shadowOpacity: 0.8,
  //   shadowRadius: 40,
