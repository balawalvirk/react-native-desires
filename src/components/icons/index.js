  ...
  return (
    <TouchableOpacity
      ...
      style={[
        ...
        appStyles.center,
        isRound && {borderRadius: responsiveWidth(100)},
        isWithBorder && {borderWidth: 1, borderColor: colors.appBorderColor2},
        {
          //height: _buttonSize,
          //width: _buttonSize,
          padding: customPadding ? customPadding : responsiveWidth(1),
      ...
      {showBadge ? (
        <Wrapper
          isAbsolute
          isCenter
          style={{top: -6, right: 1.5, ...appStyles.shadowExtraDark}}>
          <Badge
    ...
    <Wrapper animation={animation} duration={duration} style={containerStyle}>
      <TouchableOpacity disabled={!onPress} onPress={onPress}>
        <Image
          ...
          resizeMode="contain"
          style={{
            height: size ? size : Height ? Height : defaulSize,
            width: size ? size : Width ? Width : defaulSize,
            tintColor: color,
          }}
        />
      </TouchableOpacity>
