      ...
      <TouchableOpacity
        ...
        style={[
          appStyles.inputContainerBorderd,
          {
            borderRadius: sizes.inputRadius,
            borderWidth: 1.5,
            borderColor: isFocusedContainerColor
              ? isFocusedContainerColor
              : colors.appBgColor3,
          },
          containerStyle,
          ...
          {onPress ? (
            <Wrapper
              ...
              <Text
                isMedium
                style={[
                  value ? null : appStyles.textLightGray,
            ...
            <View
              style={{
                marginLeft:
                  !left && !iconNameLeft ? sizes.marginHorizontal / 2 : 0,
              }}>
              <TextInput
                multiline={multiline}
                numberOfLines={multiline && 6}
                ...
                onFocus={onFocus}
                autoFocus={autoFocus}
                selectionColor={colors.appPrimaryColor}
                placeholderTextColor={
                  placeholderTextColor
                    ? placeholderTextColor
        ...
        <View style={{}}>
          {right ? (
            ...
            <Wrapper
              style={[
                {alignItems: 'center', marginRight: sizes.marginHorizontal},
                iconContainerStyle,
              ]}>
              <Icons.Custom
